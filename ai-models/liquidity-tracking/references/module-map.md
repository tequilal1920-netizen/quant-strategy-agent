...
- 本地模型：`ai-models/liquidity-tracking/source`
- 数据契约与刷新：`ai-models/liquidity-tracking/source/data_sources.py`
- ETF 与行业刷新：`ai-models/liquidity-tracking/source/specialized_refresh.py`
- 官方来源刷新：`ai-models/liquidity-tracking/source/official_refresh.py`
- 国内图表构建：`ai-models/liquidity-tracking/source/snapshot_domestic.py`
- 正式快照入口：`ai-models/liquidity-tracking/source/build_snapshot.py`
...
- 模块元数据：`ai-models/liquidity-tracking/source/MODULE.json`
