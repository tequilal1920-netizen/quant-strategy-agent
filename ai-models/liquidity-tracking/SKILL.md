...
```powershell
python ai-models/liquidity-tracking/scripts/query.py overview
python ai-models/liquidity-tracking/scripts/query.py page 页面=外资
python ai-models/liquidity-tracking/scripts/query.py page 页面=融资
```
...
```powershell
python ai-models/liquidity-tracking/source/data_sources.py refresh `
...
```powershell
python ai-models/liquidity-tracking/source/data_sources.py audit `
  --cache database/liquidity_tracking.sqlite3 `
  --strict
```
...
```powershell
python ai-models/liquidity-tracking/source/build_snapshot.py `
...
```powershell
python -m py_compile `
  ai-models/liquidity-tracking/source/data_sources.py `
  ai-models/liquidity-tracking/source/specialized_refresh.py `
  ai-models/liquidity-tracking/source/official_refresh.py `
  ai-models/liquidity-tracking/source/snapshot_domestic.py `
  ai-models/liquidity-tracking/source/build_snapshot.py
git diff --check
