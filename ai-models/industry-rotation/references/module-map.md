...
- 本地模型：`ai-models/industry-rotation/source`
- 快照入口：`ai-models/industry-rotation/source/build_snapshot.py`
- 季度风格箱入口：`ai-models/industry-rotation/source/style_box_rotation.py`
- 跟踪入口：`ai-models/industry-rotation/source/build_tracking.py`
- 模型引擎：`ai-models/industry-rotation/source/engine.py`
- 事件覆盖：`ai-models/industry-rotation/source/event_overrides.py`
- 页面渲染：`board/quant_strategy_agent/static/js/app.js`
- 模块元数据：`ai-models/industry-rotation/source/MODULE.json`
