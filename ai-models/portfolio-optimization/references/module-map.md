...
- 一级标题：组合优化
- 二级页面：优化求解、配置策略
- 本地模型：`ai-models/portfolio-optimization/source`
- 正式引擎：`ai-models/portfolio-optimization/source/portfolio_optimization_engine.py`
...
- 模块元数据：`ai-models/portfolio-optimization/source/MODULE.json`
