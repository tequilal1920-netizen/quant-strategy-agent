...
```powershell
python -m py_compile ai-models/factor-laboratory/source/worker.py ai-models/factor-laboratory/components/llm_factor_mining/factor_miner.py board/quant_strategy_agent/factor_lab_backend.py board/services/factor_mining/app.py
