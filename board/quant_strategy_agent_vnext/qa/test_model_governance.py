...
def test_model_governance_keeps_test_report_only() -> None:
    ...
    assert payload["release"] == "2026.07.27-dense-evidence-solver-audit-r23.3"
...
def test_portfolio_governance_reads_v24_solver_audit_snapshot() -> None:
    ...
    assert model["engine"] == "portfolio-optimizer/2.4-solver-audit"
    assert model["champion"].startswith("C188 risk_adjusted_trend")
