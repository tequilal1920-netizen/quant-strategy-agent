"""Build reference-style PNG charts for the v5.7 no-gold asset-allocation block."""
...
OUTPUT_DIR = PROJECT_ROOT / "output" / "asset_allocation_global_charts_v57_no_gold"
EXPECTED_SCHEMA = "5.7.0"
EXPECTED_SNAPSHOT_HASH = "2F4B922BAF84309A1DDD4A47E4DFAACBD3EB67C42126E404342EF4F1570E617D"


def _read_snapshot() -> dict[str, Any]:
    data = json.loads(SNAPSHOT_PATH.read_text(encoding="utf-8"))
    if data.get("schema_version") != EXPECTED_SCHEMA:
        raise ValueError("asset_allocation_v57_snapshot_schema_mismatch")
    if data.get("content_sha256") != EXPECTED_SNAPSHOT_HASH:
        raise ValueError("asset_allocation_v57_snapshot_hash_mismatch")
    if data.get("asset_order") != ["equity", "bond", "commodity"]:
        raise ValueError("asset_allocation_v57_asset_order_mismatch")
    return data
...
def build() -> dict[str, Any]:
    ...
    audit: dict[str, Any] = {
        "schema_version": "asset-allocation-global-performance-charts-v57-no-gold/1.0",
